...
- Do not compare against code unless the user explicitly asks for doc-vs-code verification; use `audit-docs-against-code` for that.
...
- Not a doc-vs-code audit. Use `audit-docs-against-code` when implementation is the truth source.
- Not PRD-specific crafting. Use `prd-craft` when the document is a PRD and needs product-requirement repair.
